...
namespace osu
{
    struct DataProviderConfig
    {
        inline static const ConfigValue<std::wstring> URL = ConfigValue<std::wstring>(
            ...
            std::wstring() + L"ws" + L"://" + L"127" + L"." + L"0" + L"." + L"0" + L"." + L"1" + L":" + L"24050" + L"/websocket/v2" // Split url into parts since some anti virus software really does not like hardcoded ips
        );
